          ...
          <div>
            ...
            {isAdmin && (
              <button
                ...
                className="w-full py-3 rounded-lg font-bold mb-6 transition hover:opacity-90 flex items-center justify-center gap-2"
              ...
              <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div key={i} className="p-4 rounded-xl bg-white/5 border border-white/10">
                    ...
                    {group.map(player => (
                      <div key={player.id} className="flex items-center gap-3 py-2 border-b border-white/5 last:border-0">
                        <div className="w-8 h-8 rounded-full overflow-hidden bg-white/10 flex-shrink-0 flex items-center justify-center text-sm font-bold">
                          {player.avatar_url
                ...
                {isAdmin && (
                  <button
                    ...
                    disabled={saving}
                    className="w-full py-3 rounded-lg font-bold text-white border border-white/30 hover:bg-white/10 transition flex items-center justify-center gap-2"
                  >
                    <Check size={16} />
              ...
              <>
                <div className="flex gap-2 mb-4">
                  {(['random', 'manual'] as const).map(m => (
                    ...
                    >
                      {m === 'random' ? <Shuffle size={14} /> : <Hand size={14} />}
                ...
                {duoMode === 'random' && (
                  <button
                    ...
                    className="w-full py-3 rounded-lg font-bold mb-4 transition hover:opacity-90 flex items-center justify-center gap-2"
                    style={{ backgroundColor: 'var(--color-gold)', color: 'var(--color-green)' }}
                  >
                    <Shuffle size={16} />
                    Sortear duplas
                ...
                {duoMode === 'manual' && (
                  <div className="flex flex-col gap-3 mb-4">
                    ...
                    <button
                      ...
                      className="text-sm text-white/50 hover:text-white transition py-2 flex items-center gap-1"
                    >
                      <Plus size={14} />
                      Adicionar dupla
                    </button>
